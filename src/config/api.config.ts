...
const API_URLS = {
  development: process.env.REACT_APP_API_URL_DEV || 'https://geopressci-f3r7g97m.b4a.run/api/v1',
  production: process.env.REACT_APP_API_URL_PROD || 'https://geopressci-f3r7g97m.b4a.run/api/v1',
  // Fallback si le backend local n'est pas disponible
  fallback: process.env.REACT_APP_API_URL_PROD || 'https://geopressci-f3r7g97m.b4a.run/api/v1'
} as const;
