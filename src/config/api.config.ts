...
const API_URLS = {
  development: process.env.REACT_APP_API_URL_DEV || 'http://localhost:5002/api/v1',
  production: process.env.REACT_APP_API_URL_PROD || 'http://localhost:5002//api/v1',
  // Fallback si le backend local n'est pas disponible
  fallback: process.env.REACT_APP_API_URL_PROD || 'http://localhost:5002//api/v1'
} as const;
